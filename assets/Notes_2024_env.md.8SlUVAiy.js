import{_ as a,c as n,o as s,a4 as p}from"./chunks/framework.BZcgSH2F.js";const _=JSON.parse('{"title":"Archlinux使用python虚拟环境","description":"","frontmatter":{"title":"Archlinux使用python虚拟环境","outline":"deep","desc":"env","updateTime":"2024-07-04 16:45:57"},"headers":[],"relativePath":"Notes/2024/env.md","filePath":"Notes/2024/env.md","lastUpdated":null}'),e={name:"Notes/2024/env.md"},t=p(`<h2 id="archlinux使用python虚拟环境" tabindex="-1">Archlinux使用python虚拟环境 <a class="header-anchor" href="#archlinux使用python虚拟环境" aria-label="Permalink to &quot;Archlinux使用python虚拟环境&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>sudo pacman -S python-virtualenv</span></span>
