import{_ as a,G as s,c as p,J as e,a4 as t,o as i}from"./chunks/framework.BU4lEi6u.js";const m=JSON.parse('{"title":"Archlinux使用python虚拟环境","description":"在 Arch Linux 系统上如何创建和管理 Python 虚拟环境。包括安装 `python-virtualenv` 包、创建虚拟环境、激活和退出虚拟环境的步骤，以及如何根据不同的 shell（如 Fish）选择合适的激活脚本。","frontmatter":{"date":"2024-07-04T00:00:00.000Z","title":"Archlinux使用python虚拟环境","category":"Arch","tags":["Arch","python","env"],"description":"在 Arch Linux 系统上如何创建和管理 Python 虚拟环境。包括安装 `python-virtualenv` 包、创建虚拟环境、激活和退出虚拟环境的步骤，以及如何根据不同的 shell（如 Fish）选择合适的激活脚本。"},"headers":[],"relativePath":"posts/env.md","filePath":"posts/env.md"}'),c={name:"posts/env.md"},l=t(`<h2 id="archlinux使用python虚拟环境" tabindex="-1">Archlinux使用python虚拟环境 <a class="header-anchor" href="#archlinux使用python虚拟环境" aria-label="Permalink to &quot;Archlinux使用python虚拟环境&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>sudo pacman -S python-virtualenv</span></span>
